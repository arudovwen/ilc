...
<div>
   ...
   <b-modal id="assign-class" scrollable title="Assign Head " size="lg" hide-footer>
   <div>
         ...
         <b-form-select v-model="current" >
           <b-form-select-option value="" disabled>Select Level</b-form-select-option>
             <b-form-select-option value="" >All </b-form-select-option>
               <b-form-select-option :value="item.class_name" v-for="(item,idx) in allClass"
            :key="idx">{{item.class_name}}</b-form-select-option>
         </b-form-select>
      </b-col>
     </b-row>
