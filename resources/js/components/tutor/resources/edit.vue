        ...
        .then(res => {
          if (res.status == 200) {
            this.resource = res.data.data;
             this.resource.level = res.data.data.level.toLowerCase();

              this.resource.subject = res.data.data.subject.toLowerCase();
               this.resource.module = res.data.data.title.toLowerCase();
            this.resource.content = JSON.parse(res.data.data.content);
             this.getModules()
          }
        });
    },
